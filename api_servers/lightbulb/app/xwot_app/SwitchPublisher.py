...
#
@app.route('/lightbulb/switch/pub', methods=['GET'])
...
#
@app.route('/lightbulb/switch/pub', methods=['POST'])
...
#
@app.route('/lightbulb/switch/pub/', branch=True)
...
#
@app.route('/lightbulb/switch/pub', methods=['OPTIONS'])
