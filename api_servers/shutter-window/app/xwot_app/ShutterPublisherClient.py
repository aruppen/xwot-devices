...
#
@app.route('/window/shutter/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/window/shutter/pub/<clientid>', methods=['GET'])
...
#
@app.route('/window/shutter/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/window/shutter/pub/<clientid>', methods=['DELETE'])
