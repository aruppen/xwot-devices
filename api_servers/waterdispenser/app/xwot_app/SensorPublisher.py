...
#
@app.route('/waterdispenser/sensor/pub', methods=['GET'])
def handle_sensor_pub_GET(request):
...
#
@app.route('/waterdispenser/sensor/pub', methods=['POST'])
...
#
@app.route('/waterdispenser/sensor/pub/', branch=True)
def handle_sensor_pub_ws(request):
...
#
@app.route('/waterdispenser/sensor/pub', methods=['OPTIONS'])
def handle_sensor_pub_OPTIONS(request):
    cors(request, methods=['GET', 'PUT', 'OPTIONS'])
    request.setHeader('Allow', 'GET, PUT, OPTIONS')
