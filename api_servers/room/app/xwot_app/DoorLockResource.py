...
# GET '/room/door/lock'
#
@app.route('/room/door/lock', methods=['GET'])
def handle_room_door_lock_GET(request):
    if xwot_app.resources['door_lock']:
        accept = request.getHeader('Accept')
        d = treq.get(xwot_app.resources['door_lock'], headers={'Accept': 'application/json'})
...
# PUT '/room/door/lock'
#
@app.route('/room/door/lock', methods=['PUT'])
def handle_room_door_lock_PUT(request):
    if xwot_app.resources['door_lock']:
        ...
        accept = request.getHeader('Accept')
        d = treq.put(xwot_app.resources['door_lock'], data=_data, headers={'Content-Type': 'application/json'})
        request.setHeader('Content-Type', accept)
        d.addCallback(treq.content)
