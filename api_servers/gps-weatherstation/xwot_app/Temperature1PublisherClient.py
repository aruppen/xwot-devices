...
#
@app.route('/weatherstation/sensors/temperature1/pub/<clientid>', methods=['OPTIONS'])
def handle_windows_windows_pub_clientid_OPTIONS6(request, clientid):
    cors(request, methods=['GET', 'PUT', 'OPTIONS'])
    request.setHeader('Allow', 'GET, PUT, OPTIONS')

## GET '/windows/windows/pub/<clientid>'
#
@app.route('/weatherstation/sensors/temperature1/pub/<clientid>', methods=['GET'])
...
#
@app.route('/weatherstation/sensors/temperature1/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/weatherstation/sensors/temperature1/pub/<clientid>', methods=['DELETE'])
def handle_windows_windows_pub_clientid_DELETE6(request, clientid):
    cors(request, methods=['GET', 'PUT', 'OPTIONS'])
    request.setHeader('Allow', 'GET, PUT, OPTIONS')
    logging.debug(request.requestHeaders)
    accept_type = request.requestHeaders.getRawHeaders("Accept")[0].split(
