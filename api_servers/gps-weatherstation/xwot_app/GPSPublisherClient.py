...
#
@app.route('/weatherstation/sensors/gps/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/weatherstation/sensors/gps/pub/<clientid>', methods=['GET'])
def handle_windows_windows_pub_clientid_GET2(request, clientid):
...
#
@app.route('/weatherstation/sensors/gps/pub/<clientid>', methods=['PUT'])
def handle_windows_windows_pub_clientid_PUT2(request, clientid):
    logging.debug(request.requestHeaders)
    cors(request, methods=['GET', 'PUT', 'OPTIONS'])
    request.setHeader('Allow', 'GET, PUT, OPTIONS')
...
#
@app.route('/weatherstation/sensors/gps/pub/<clientid>', methods=['DELETE'])
def handle_windows_windows_pub_clientid_DELETE2(request, clientid):
    cors(request, methods=['GET', 'PUT', 'OPTIONS'])
    request.setHeader('Allow', 'GET, PUT, OPTIONS')
    logging.debug(request.requestHeaders)
    accept_type = request.requestHeaders.getRawHeaders("Accept")[0].split(
