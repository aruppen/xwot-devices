...
from TemperatureResource import DHT_Temperature
...
#
@app.route('/dht22/temperature/pub/', branch=True)
def handle_windows_windows_pub_ws(request):
    ServerFactory = xWoTBroadcastFactory
    dht_temp = DHT_Temperature()
    factory = ServerFactory("ws://localhost:5000/", dht_temp, debug = False,  debugCodePaths = False)
...
#
@app.route('/dht22/temperature/pub', methods=['OPTIONS'])
