...
#
@app.route('/dht22/temperature/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/dht22/temperature/pub/<clientid>', methods=['GET'])
...
#
@app.route('/dht22/temperature/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/dht22/temperature/pub/<clientid>', methods=['DELETE'])
