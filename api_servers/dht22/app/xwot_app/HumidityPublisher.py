...
from HumidityResource import DHT_Humidity
...
#
@app.route('/dht22/humidity/pub/', branch=True)
def handle_windows_windows_pub_ws(request):
    ServerFactory = xWoTBroadcastFactory
    dht_humidity = DHT_Humidity()
    factory = ServerFactory("ws://localhost:5000/", dht_humidity, debug = False,  debugCodePaths = False)
...
#
@app.route('/dht22/humidity/pub', methods=['OPTIONS'])
