...
#
@app.route('/dht22/humidity/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/dht22/humidity/pub/<clientid>', methods=['GET'])
...
#
@app.route('/dht22/humidity/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/dht22/humidity/pub/<clientid>', methods=['DELETE'])
