...
#
@app.route('/sensing-device/humidity/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/sensing-device/humidity/pub/<clientid>', methods=['GET'])
...
#
@app.route('/sensing-device/humidity/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/sensing-device/humidity/pub/<clientid>', methods=['DELETE'])
