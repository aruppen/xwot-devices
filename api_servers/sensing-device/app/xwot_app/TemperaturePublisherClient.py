...
#
@app.route('/sensing-device/temperature/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/sensing-device/temperature/pub/<clientid>', methods=['GET'])
...
#
@app.route('/sensing-device/temperature/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/sensing-device/temperature/pub/<clientid>', methods=['DELETE'])
