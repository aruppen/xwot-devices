...
#
@app.route('/sensing-device/temperature/pub', methods=['GET'])
...
#
@app.route('/sensing-device/temperature/pub', methods=['POST'])
...
#
@app.route('/sensing-device/temperature/pub/', branch=True)
def handle_windows_windows_pub_ws(request):
    ServerFactory = xWoTBroadcastFactory
    temperature_sensor = TemperatureSensor()
    factory = ServerFactory("ws://localhost:5000/", temperature_sensor, debug = False,  debugCodePaths = False)
...
#
@app.route('/sensing-device/temperature/pub', methods=['OPTIONS'])
