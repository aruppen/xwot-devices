...
#
@app.route('/door/handle/pub', methods=['GET'])
...
#
@app.route('/door/handle/pub', methods=['POST'])
...
#
@app.route('/door/handle/pub/', branch=True)
...
#
@app.route('/door/handle/pub', methods=['OPTIONS'])
