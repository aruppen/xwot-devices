...
#
@app.route('/door/lock/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/door/lock/pub/<clientid>', methods=['GET'])
...
#
@app.route('/door/lock/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/door/lock/pub/<clientid>', methods=['DELETE'])
