...
#
@app.route('/weatherstation/sensors/altitude/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/weatherstation/sensors/altitude/pub/<clientid>', methods=['GET'])
...
#
@app.route('/weatherstation/sensors/altitude/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/weatherstation/sensors/altitude/pub/<clientid>', methods=['DELETE'])
