...
#
@app.route('/weatherstation/sensors/altitude/pub', methods=['GET'])
...
#
@app.route('/weatherstation/sensors/altitude/pub', methods=['POST'])
...
#
@app.route('/weatherstation/sensors/altitude/pub/', branch=True)
def handle_windows_windows_pub_ws(request):
    ServerFactory = xWoTBroadcastFactory
    altitude_sensor = sensors_dic['altitude']
    factory = ServerFactory("ws://localhost:5000/", altitude_sensor, debug = False,  debugCodePaths = False)
...
#
@app.route('/weatherstation/sensors/altitude/pub', methods=['OPTIONS'])
