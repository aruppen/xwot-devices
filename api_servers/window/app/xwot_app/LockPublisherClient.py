...
#
@app.route('/window/lock/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/window/lock/pub/<clientid>', methods=['GET'])
...
#
@app.route('/window/lock/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/window/lock/pub/<clientid>', methods=['DELETE'])
