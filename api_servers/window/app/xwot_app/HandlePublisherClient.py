...
#
@app.route('/window/handle/pub/<clientid>', methods=['OPTIONS'])
...
#
@app.route('/window/handle/pub/<clientid>', methods=['GET'])
...
#
@app.route('/window/handle/pub/<clientid>', methods=['PUT'])
...
#
@app.route('/window/handle/pub/<clientid>', methods=['DELETE'])
